...
class engine_sequentialc_cpu : public engine_base
{
...
public:
  ...
  const static uint8_t N_OPS = NE /*acc*/ + NE * NP /*flux beta star*/ + NP /*UPSAT*/ + NE * NP /*gradient*/ + NE /*kinetic*/ + 2 /*rock*/ + 2 * NP /*gravpc*/ + 1 /*poro*/ + 1;
  // order of operators:
  ...
  //const static uint8_t LAMB_OP = NE + NE * NP + NP + NE * NP + NE + 3 + 2 * NP + NP;
...
#include "engine_sequentialc_cpu.tpp"
