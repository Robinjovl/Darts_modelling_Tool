...
class multilinear_adaptive_cpu_interpolator_dynamic : public multilinear_interpolator_base_dynamic<index_t, value_t>
{
public:
    using typename multilinear_interpolator_base_dynamic<index_t, value_t>::point_coordinates_t;
    using typename multilinear_interpolator_base_dynamic<index_t, value_t>::point_data_t;
    using typename multilinear_interpolator_base_dynamic<index_t, value_t>::hypercube_data_t;
    using typename multilinear_interpolator_base_dynamic<index_t, value_t>::hypercube_points_index_t;
    /**
      * @brief Construct the interpolator with specified parametrization space
      *
      * @param[in] supporting_point_evaluator    Object used to compute operators values at supporting points
