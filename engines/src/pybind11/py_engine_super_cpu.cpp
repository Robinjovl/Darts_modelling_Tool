...
struct engine_super_exposer
{
    ...
    py::class_<engine_super_cpu<NC, NP, THERMAL>, engine_base>(m, short_name.c_str(), long_name.c_str())   \
      ...
      .def_readwrite("darcy_forchheimer_volumetric_rate", &engine_super_cpu<NC, NP, THERMAL>::darcy_forchheimer_volumetric_rate) \
      .def_readwrite("darcy_forchheimer_velocities_n", &engine_super_cpu<NC, NP, THERMAL>::darcy_forchheimer_velocities_n);
	}
};
