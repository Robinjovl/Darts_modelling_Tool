...
void pybind_globals(py::module &m)
{
  ...
  sim_params.def(py::init<>())
    ...
    .def_readwrite("well_rate_ctrl_absolute_residual_scale", &sim_params::well_rate_ctrl_absolute_residual_scale)
    .def_readwrite("well_rate_ctrl_relative_residual_scale", &sim_params::well_rate_ctrl_relative_residual_scale)
