#ifndef CPU_SIMULATOR_NC_NONNEWTON_HPP
#define CPU_SIMULATOR_NC_NONNEWTON_HPP
...
class engine_nc_nonnewton_cpu : public engine_base
{
...
public:
  ...
  engine_nc_nonnewton_cpu() { engine_name = "Multiphase " + std::to_string(NC) + "-component isothermal flow with nonnewtonian property CPU engine"; };
