...
void pybind_discretizer(py::module &m)
{
	...
	py::class_<Discretizer>(m, "Discretizer", py::module_local())
		...
		.def_readwrite("p_grad_vals", &Discretizer::p_grad_vals)
		.def_readwrite("t_grad_vals", &Discretizer::t_grad_vals)
		.def_readwrite("p_grad_rhs", &Discretizer::p_grad_rhs)
