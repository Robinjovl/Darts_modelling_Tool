...
namespace dis
{
	 ...
	 *
	 * This class holds data for boundary elements, supporting both Dirichlet and Neumann types.
	 */
	...
	public:
	  ...
	  /**
	   * @brief Default constructor for GenericBoundaryCondition.
	   */
	  GenericBoundaryCondition() {};

	  /**
	   * @brief Destructor for GenericBoundaryCondition.
	   */
	  ~GenericBoundaryCondition() {};
	};

	/**
	 * @brief Boundary condition class for Thermo-Hydro-Mechanical (THM) coupled problems.
	 *
	 * This class aggregates various types of boundary conditions relevant for THM analysis,
	 * including flow, thermal, and mechanical (both normal and tangential).
	 */
	class THMBoundaryCondition
	{
	public:
	  GenericBoundaryCondition flow;        ///< Flow boundary conditions.
	  GenericBoundaryCondition thermal;     ///< Thermal boundary conditions.
	  GenericBoundaryCondition mech_normal; ///< Mechanical normal boundary conditions.
	  GenericBoundaryCondition mech_tangen; ///< Mechanical tangential boundary conditions.

	  /**
	   * @brief Default constructor for THMBoundaryCondition.
	   */
	  THMBoundaryCondition() {};

	  /**
	   * @brief Destructor for THMBoundaryCondition.
	   */
	  ~THMBoundaryCondition() {};
	};
