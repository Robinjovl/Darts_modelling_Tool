...
void bind_unified_solver_api(py::module &m)
{
    ...
    py::class_<cpr_solver_config, solver_config>(m, "CPRSolverConfig",
        ...
        // Pressure-stage BoomerAMG knobs (negative = keep the HYPRE default;
        // defaults mirror the proprietary BOS AMG profile).
        .def_readwrite("amg_coarsen_type", &cpr_solver_config::amg_coarsen_type)
        .def_readwrite("amg_interp_type", &cpr_solver_config::amg_interp_type)
        .def_readwrite("amg_relax_type", &cpr_solver_config::amg_relax_type)
        .def_readwrite("amg_relax_order", &cpr_solver_config::amg_relax_order)
        .def_readwrite("amg_num_sweeps", &cpr_solver_config::amg_num_sweeps)
        .def_readwrite("amg_strong_threshold", &cpr_solver_config::amg_strong_threshold)
        .def_readwrite("amg_agg_num_levels", &cpr_solver_config::amg_agg_num_levels)
        .def_readwrite("amg_agg_interp_type", &cpr_solver_config::amg_agg_interp_type)
        .def_readwrite("amg_agg_pmax_elmts", &cpr_solver_config::amg_agg_pmax_elmts)
        .def_readwrite("amg_pmax_elmts", &cpr_solver_config::amg_pmax_elmts)
        .def_readwrite("amg_trunc_factor", &cpr_solver_config::amg_trunc_factor)
        .def_readwrite("amg_max_levels", &cpr_solver_config::amg_max_levels)
        .def_readwrite("amg_cycle_type", &cpr_solver_config::amg_cycle_type)
        .def_readwrite("amg_max_coarse_size", &cpr_solver_config::amg_max_coarse_size)
        .def_readwrite("amg_coarse_relax_type", &cpr_solver_config::amg_coarse_relax_type)
        .def_readwrite("amg_relax_wt", &cpr_solver_config::amg_relax_wt)
        // CPR formulation knobs (see cpr_solver_config).
        .def_readwrite("weight_scheme", &cpr_solver_config::weight_scheme)
        .def_readwrite("stage2_type", &cpr_solver_config::stage2_type)
        .def_readwrite("eager_adjoint", &cpr_solver_config::eager_adjoint)
