...
#pragma unroll
    ...
    template <uint8_t n_block_size>
    linsolv_cpr_gpu<n_block_size>::linsolv_cpr_gpu()
    {
    ...
    template <uint8_t n_block_size>
    void linsolv_cpr_gpu<n_block_size>::setup_kernel()
    {
    }

    template <uint8_t n_block_size>
    int linsolv_cpr_gpu<n_block_size>::init(opendarts::linear_solvers::csr_matrix_base *A,
    ...
    template <uint8_t n_block_size>
    int linsolv_cpr_gpu<n_block_size>::setup(opendarts::linear_solvers::csr_matrix_base *A_)
    {
      cudaError_t cudaStat;
    ...
    template <uint8_t n_block_size>
    int linsolv_cpr_gpu<n_block_size>::refresh_transpose_chain()
    {
      if (!A_base)
        return -1;
      if (!p_system_preconditioner_t)
    ...
    template <uint8_t n_block_size>
    int linsolv_cpr_gpu<n_block_size>::solve(value_t *B, value_t *X)
    {
    ...
    template <uint8_t n_block_size>
    int linsolv_cpr_gpu<n_block_size>::solve_transposed(value_t *B, value_t *X)
    {
...
#include "linsolv_cpr_gpu_instantiations.inc"
  } // namespace linear_solvers
} // namespace opendarts
