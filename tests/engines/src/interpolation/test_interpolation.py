...
test_interpolator_convergence(
    itor_type='linear', itor_mode='adaptive', n_dim=4, is_barycentric=False, norm=np.inf
)
test_interpolator_convergence(
    itor_type='linear', itor_mode='adaptive', n_dim=4, is_barycentric=True, norm=np.inf
)
