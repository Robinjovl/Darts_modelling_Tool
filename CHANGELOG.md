# #.#.# [Future]
- Add hysteresis support for OBL-based compositional simulations through per-cell history variables, including Killough scanning-curve handling and a `2ph_hysteresis` reference example with regression PKL files ([!310](https://gitlab.com/open-darts/open-darts/-/merge_requests/310)).
  More implementation details, API updates, and integration notes are documented in the MR: https://gitlab.com/open-darts/open-darts/-/merge_requests/310
