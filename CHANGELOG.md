...
- Breaking changes:\
	...
	Any model should have a set_sim_params(...) call after physics initialization, where a DataTS instance is created or create it manually using self.data_ts = DataTS(n_vars).
