...
namespace opendarts
{
  namespace linear_solvers
  {
    ...
    template class linsolv_amgx<1>;
    template class linsolv_amgx<2>;
    template class linsolv_amgx<3>;
    template class linsolv_amgx<4>;
    template class linsolv_amgx<5>;
    template class linsolv_amgx<6>;
    template class linsolv_amgx<7>;
    template class linsolv_amgx<8>;
    template class linsolv_amgx<9>;
    template class linsolv_amgx<10>;
    template class linsolv_amgx<11>;
    template class linsolv_amgx<12>;
    template class linsolv_amgx<13>;
  } // namespace linear_solvers
} // namespace opendarts
