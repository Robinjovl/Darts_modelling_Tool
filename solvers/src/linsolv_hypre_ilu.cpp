...
namespace opendarts
{
  namespace linear_solvers
  {
    ...
    // Instantiated for block size 1 only: for block sizes > 1 a matrix copy
    // would be required (conversion to a 1x1 block matrix).
...
#include "linsolv_hypre_ilu_instantiations.inc"
  } // namespace linear_solvers
} // namespace opendarts
