...
namespace opendarts
{
  namespace linear_solvers
  {
    ...
    // Explicit template instantiations for N=1..OPENDARTS_MAX_DIMS+1 — generated by
    // CMake's od_emit_template_instantiations(); see solvers/linear_solvers/src/
    // CMakeLists.txt. Edit the bound there, not here.
