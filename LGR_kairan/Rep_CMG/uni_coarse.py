...
class Model(DartsModel):
    ...
    def set_wells(self):
        ...
        for k in range(self.nz_over, self.nz_over + self.nz_res):         
            self.reservoir.add_perforation("I1", res_cell_idx=(20,40,k), ms_epm=True)

        self.reservoir.add_well("P1")
        for k in range(self.nz_over, self.nz_over + self.nz_res):         
            self.reservoir.add_perforation("P1", res_cell_idx=(60,40,k), ms_epm=True)
    ...
    # try to set injector only at beginning
