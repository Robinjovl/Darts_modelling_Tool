...
The openDARTS framework is fully validated and benchmarked for geothermal applications showing similar accuracy as state-of-the-art simulators TOUGH2 and AD-GPRS while providing a noticeable reduction in CPU time mainly due to the OBL approach [@Wang2020]. In the modeling of CO2 geological storage, openDARTS was one of the frameworks tested on the FluidFlower validation benchmark study [@fluidflower2023], where it was compared with experiments and other simulators [@Wapperom2023; Hoop2024; Ahusborde2024]. Additionally, openDARTS has been used for studying hydrocarbon production [@Lyu2021], when it was validated against commercial simulator, and for modeling of induced seismicity phenomenon being validated against semi-analytical benchmarks and PorePy simulation tool [@Novikov2022].
