...
* Inclusion of specific potential energy in the energy conservation equation
  * To consider specific potential energy in the energy conservation equation: 
      ...
      3. Instead of zero as the input argument of the following line: self.mesh.init_spe(grav_acc=0), specify the desired gravitational acceleration (for the Earth: 9.80665)