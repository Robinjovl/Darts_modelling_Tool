...
def calc_intersections_segm_parallel(
    ...
    if number_partitions > 1:
        act_frac_sys_list, frac_order_vec_list, partition_lines = partition_domain(
            act_frac_sys,
            frac_order_vec,
            tolerance_intersect,
            number_partitions_x,
        ...
        for partition in range(number_partitions):
            ...
            p = mp.Process(
                target=calc_intersections_worker,
                args=(
                    partition,
                    send_end,
