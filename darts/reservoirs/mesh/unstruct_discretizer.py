...
class UnstructDiscretizer:
    ...
    available_matrix_geometries = ['hexahedron', 'wedge', 'tetra', 'pyramid']
    ...
    def load_mesh(self, permx, permy, permz, frac_aper, cache: bool = False):
        ...
        if not read_from_cache:
            ...
            self.perm_y_cell = self.check_matrix_data_input(permy, 'permy')
            self.perm_z_cell = self.check_matrix_data_input(permz, 'permz')
    ...
    def calc_boundary_cells_new(self, boundary_data):
        ...
        boundary_cells = np.array(list(boundary_cells.values()), dtype=int) + self.frac_cells_tot
