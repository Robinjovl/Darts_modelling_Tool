    ...
    def run(
        ...
        while t < stop_time:
            ...
            if converged:
                ...
                if verbose:
                    print(
                        f"# {ts_counter:d}\tT = {t:3g}\tDT = {dt:2g}\tNI = {self.physics.engine.n_newton_last_dt:d}\tLI={self.physics.engine.n_linear_last_dt:d}\tDT_MULT={dt_mult_new:3.3g}\tdX={np.round(max_dx, 3)}"
                    )
