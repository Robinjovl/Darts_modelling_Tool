    ...
    def run(
        ...
        while t < stop_time:
            ...
            if converged:
                ...
                self.physics.engine.darcy_forchheimer_velocities_n = value_vector(
                    np.array(self.physics.engine.darcy_forchheimer_volumetric_rate)
                    / np.array(self.reservoir.mesh.connection_area)
                )
