...
class Pipe:
    ...
    def update_ske_seg0(self, vG0, vL0, sG0, rhoG0, rhoL0):
        ...
        self.phases_ske_seg0[0::nph] = gas_ske_seg0 * 1e-3  # convert J/kg to kJ/kg
        self.phases_ske_seg0[1::nph] = liquid_ske_seg0 * 1e-3  # convert J/kg to kJ/kg
