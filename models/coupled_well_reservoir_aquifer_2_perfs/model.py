...
class Model(CICDModel):
    def __init__(self):
        ...
        self.set_sim_params(first_ts=0.0001/(24*60*60), mult_ts=2, max_ts=1/(24*60*60), tol_newton=1e-6, tol_linear=1e-3,
    ...
    def set_wells(self):
        ...
        self.reservoir.add_perforation(well_1_name, res_cell_idx=(1, 1, 2), well_seg_idx=57, well_ID=well_1_geometry.pipe_ID)
