...
class Model(CICDModel):
    def __init__(self):
        ...
        self.set_sim_params(first_ts=0.0001/(24*60*60), mult_ts=2, max_ts=2/(24*60*60), tol_newton=1e-8, tol_linear=1e-3,
