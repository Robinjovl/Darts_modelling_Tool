...
class Model(CICDModel):
    ...
    def set_wells(self):
        ...
        initial_CO2_mole_fraction = [initial_fluid_conditions['phases_compositions'][0][
                                         0]] * well_1_geometry.num_segments
        initial_C1_mole_fraction = [initial_fluid_conditions['phases_compositions'][0][
                                        1]] * well_1_geometry.num_segments
