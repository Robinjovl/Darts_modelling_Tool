...
class Model(CICDModel):
    ...
    def set_wells(self):
        ...
        initial_conditions_dict = {'phases_names': ['gas'], 'phases_compositions': [[1 - 2 * 1e-5, 1e-5, 1e-5]],
        ...
        self.reservoir.add_perforation(well_1_name, res_cell_idx=(1, 1, 6), well_seg_idx=20, well_ID=well_1_geometry.pipe_ID)
