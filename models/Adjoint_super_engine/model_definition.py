    ...
    def set_wells(self):
        ...
        for i, inj in enumerate(self.inj_list):
            ...
            for k in range(n_perf):
                self.reservoir.add_perforation('I' + str(i + 1), res_cell_idx=(inj[0], inj[1], k + 1), well_ID=0.2,
                                               well_index=WI)
        ...
        for p, prod in enumerate(self.prod_list):
            ...
            for k in range(n_perf):
                self.reservoir.add_perforation('P' + str(p + 1), res_cell_idx=(prod[0], prod[1], k + 1), well_ID=0.2,
                                               well_index=WI)
