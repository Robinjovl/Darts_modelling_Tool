...
class Model(CICDModel):
    ...
    def set_reservoir(self):
        nx = 101
        self.reservoir = StructReservoir(self.timer, nx=nx, ny=1, nz=1, dx=1, dy=1, dz=50,
    ...
    def set_wells(self):
        ...
        pipe_head_pressure = 22.144659  # bar
        pipe_head_temperature = 15 + 273.15  # Kelvin
        temp_grad = 0.03077  # deg C/meter
