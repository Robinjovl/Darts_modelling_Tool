...
def input_data_case_51x51x1_no_burden(idata: InputData, case: str):
    input_data_case_51x51x1(idata, case)
    idata.geom.burden_layers = 0  # the number of additional (generated on-the-fly) overburden/underburden layers
