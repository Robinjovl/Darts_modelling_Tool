...
from case_generate_51x51x1 import input_data_case_51x51x1, input_data_case_51x51x1_no_burden
from case_generate_100x100x100 import input_data_case_100x100x100
from case_40x40x10 import input_data_case_40x40x10, input_data_case_40x40x10_hcap, input_data_case_40x40x10_regions


def set_input_data(idata: InputData, case: str):
    if 'generate_5x3x4' in case:
        input_data_case_5x3x4(idata, case)
    elif 'generate_51x51x1_no_burden' in case:
        input_data_case_51x51x1_no_burden(idata, case)
    ...
    elif '40x40x10_hcap' in case:
        input_data_case_40x40x10_hcap(idata, case)
    elif '40x40x10_regions' in case:
        input_data_case_40x40x10_regions(idata, case)
