...
```
`GeothermalPH` reads the unbounded OBL grid from `idata.obl.p_origin`, `idata.obl.e_origin`,
`idata.obl.p_step`, and `idata.obl.e_step`; there is no separate bounds update step.
