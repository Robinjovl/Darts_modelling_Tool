...
class Model(CICDModel):
    ...
    def set_reservoir(self):
        ...
        self.reservoir = StructRadialReservoir(self.timer, nr=nr, nz=nz, dr=dr, dz=dz, poro=poro.flatten(order='F'),
                                               ...
                                               R0=self.well_1_ID / 2, R1=10, logspace=True, rcond=3.0 * 86.4, hcap=5250,
    ...
    def set_initial_conditions(self):
        p_init_res = 20.0   # from the pressure of the perforated segment of the wellbore
    ...
    def set_wells(self):
        ...
        pipe_head_pressure = 14.02051  # bar
        ...
        ramp_up_rate = UpstreamRampUpRate(well_1_name, well_1_geometry, self.physics, self.data_ts.dt_first, inj_segment_idx,
                                          target_inj_rate, ramp_up_period, composition=inj_phase_comp,
                                          pressure=injected_fluid_pressure, temperature=injected_fluid_temperature,
                                          phase_name=inj_phase_name, verbose=verbose)
