...
class Model(CICDModel):
    def __init__(self):
        ...
        self.set_sim_params(first_ts=0.0001/(24*60*60), mult_ts=2, max_ts=10/(24*60*60), tol_newton=1e-6, tol_linear=1e-6,
    ...
    def set_physics(self):
        ...
        property_container = PropertyContainer(phases_name=phases_names, components_name=components_names, Mw=comp_data.Mw,
                                               temperature=None, rock_comp=0, min_z=zero / 10)
    ...
    def set_wells(self):
        ...
        well_1_initial_conditions = SingleAmbientTemperature(well_1_name, well_1_geometry, self.physics, wellbore_fluid_temp,
    ...
    def set_rhs_flux(self, t: float = None) -> np.ndarray:
        ...
        injected_fluid_specific_enthalpy = self.physics.property_containers[0].enthalpy_ev['gas'].evaluate(injected_fluid_pressure, injected_fluid_temperature, injected_fluid_mole_fractions)  # Constant injection specific enthalpy
